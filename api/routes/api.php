...
use App\Http\Controllers\V1\{AuthController, AdminController, ClientController, MercadoPagoController, RifasController, PixController, SiteConfigController, EscaleCyberWebhookController};
...
Route::post("/escale-cyber-webhook", [EscaleCyberWebhookController::class, 'handle']);
